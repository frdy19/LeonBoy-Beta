            ...
            if (!("BannedReason" in user)) user.BannedReason = ""
              ...
              if (!("title" in user)) user.title = ""
                ...
                if (!user.registered) {
                    ...
                    if (!isNumber(user.anggur)) user.anggur = 100
                    if (!isNumber(user.apel)) user.apel = 100
                    if (!isNumber(user.bibitanggur)) user.bibitanggur = 100
                    if (!isNumber(user.bibitapel)) user.bibitapel = 100
                    if (!isNumber(user.bibitjeruk)) user.bibitjeruk = 100
                    if (!isNumber(user.bibitmangga)) user.bibitmangga = 100
                    if (!isNumber(user.bibitpisang)) user.bibitpisang = 100
                    if (!isNumber(user.emas)) user.emas = 100
                    if (!isNumber(user.jeruk)) user.jeruk = 100
                    if (!isNumber(user.kayu)) user.kayu = 100
                    if (!isNumber(user.makanan)) user.makanan = 100
                    if (!isNumber(user.mangga)) user.mangga = 100
                    if (!isNumber(user.pisang)) user.pisang = 100
                    if (!isNumber(user.premiumDate)) user.premiumDate = -1
                    if (!isNumber(user.regTime)) user.regTime = -1
                    if (!isNumber(user.semangka)) user.semangka = 100
                    if (!isNumber(user.stroberi)) user.stroberi = 100
                }
              
              
              if (!isNumber(user.afk)) user.afk = -1
              if (!isNumber(user.agility)) user.agility = 0
              if (!isNumber(user.anakanjing)) user.anakanjing = 55
              if (!isNumber(user.anakcentaur)) user.anakcentaur = 55
              if (!isNumber(user.anakgriffin)) user.anakgriffin = 55
              if (!isNumber(user.balance)) user.balance = 55 
              if (!isNumber(user.anakkucing)) user.anakkucing = 55
              if (!isNumber(user.anakkuda)) user.anakkuda = 55
              if (!isNumber(user.anakkyubi)) user.anakkyubi = 55
              if (!isNumber(user.anaknaga)) user.anaknaga = 55
              if (!isNumber(user.anakpancingan)) user.anakpancingan = 55
              if (!isNumber(user.anakphonix)) user.anakphonix = 55
              if (!isNumber(user.anakrubah)) user.anakrubah = 55
              if (!isNumber(user.anakserigala)) user.anakserigala = 55
              if (!isNumber(user.anggur)) user.anggur = 55
              if (!isNumber(user.anjing)) user.anjing = 0
              if (!isNumber(user.anjinglastclaim)) user.anjinglastclaim = 0
              if (!isNumber(user.antispam)) user.antispam = 0
              if (!isNumber(user.antispamlastclaim)) user.antispamlastclaim = 0
              if (!isNumber(user.apel)) user.apel = 55
              if (!isNumber(user.aqua)) user.aqua = 55
              if (!isNumber(user.arc)) user.arc = 55
              if (!isNumber(user.arcdurability)) user.arcdurability = 55
              if (!isNumber(user.arlok)) user.arlok = 55
              if (!isNumber(user.armor)) user.armor = 55
              if (!isNumber(user.armordurability)) user.armordurability = 55
              if (!isNumber(user.armormonster)) user.armormonster = 55
              if (!isNumber(user.as)) user.as = 55
              if (!isNumber(user.atm)) user.atm = 55
              if (!isNumber(user.axe)) user.axe = 55
              if (!isNumber(user.axedurability)) user.axedurability = 55
              if (!isNumber(user.ayam)) user.ayam = 55
              if (!isNumber(user.ayamb)) user.ayamb = 55
              if (!isNumber(user.ayambakar)) user.ayambakar = 55
              if (!isNumber(user.ayamg)) user.ayamg = 55
              if (!isNumber(user.ayamgoreng)) user.ayamgoreng = 55
              if (!isNumber(user.babi)) user.babi = 55
              if (!isNumber(user.babihutan)) user.babihutan = 55
              if (!isNumber(user.babipanggang)) user.babipanggang = 55
              if (!isNumber(user.bandage)) user.bandage = 55
              if (!isNumber(user.bank)) user.bank = 55
              if (!isNumber(user.banteng)) user.banteng = 55
              if (!isNumber(user.batu)) user.batu = 55
              if (!isNumber(user.bawal)) user.bawal = 55
              if (!isNumber(user.bawalbakar)) user.bawalbakar = 55
              if (!isNumber(user.bayam)) user.bayam = 55
              if (!isNumber(user.berlian)) user.berlian = 155
              if (!isNumber(user.bibitanggur)) user.bibitanggur = 55
              if (!isNumber(user.bibitapel)) user.bibitapel = 55
              if (!isNumber(user.bibitjeruk)) user.bibitjeruk = 55
              if (!isNumber(user.bibitmangga)) user.bibitmangga = 55
              if (!isNumber(user.bibitpisang)) user.bibitpisang = 55
              if (!isNumber(user.botol)) user.botol = 55
              if (!isNumber(user.bow)) user.bow = 55
              if (!isNumber(user.bowdurability)) user.bowdurability = 55
              if (!isNumber(user.boxs)) user.boxs = 55
              if (!isNumber(user.brick)) user.brick = 55
              if (!isNumber(user.brokoli)) user.brokoli = 55
              if (!isNumber(user.buaya)) user.buaya = 55
              if (!isNumber(user.buntal)) user.buntal = 55
              if (!isNumber(user.cat)) user.cat = 55
              if (!isNumber(user.catexp)) user.catexp = 55
              if (!isNumber(user.catlastfeed)) user.catlastfeed = 0
              if (!isNumber(user.centaur)) user.centaur = 55
              if (!isNumber(user.centaurexp)) user.centaurexp = 0
              if (!isNumber(user.centaurlastclaim)) user.centaurlastclaim = 0
              if (!isNumber(user.centaurlastfeed)) user.centaurlastfeed = 0
              if (!isNumber(user.clay)) user.clay = 55
              if (!isNumber(user.coal)) user.coal = 55
              if (!isNumber(user.coin)) user.coin = 55
              if (!isNumber(user.common)) user.common = 55
              if (!isNumber(user.crystal)) user.crystal = 55
              if (!isNumber(user.cumi)) user.cumi = 55
              if (!isNumber(user.cupon)) user.cupon = 55
              if (!isNumber(user.diamond)) user.diamond = 55
              if (!isNumber(user.dog)) user.dog = 55
              if (!isNumber(user.dogexp)) user.dogexp = 55
              if (!isNumber(user.doglastfeed)) user.doglastfeed = 55
              if (!isNumber(user.dory)) user.dory = 55
              if (!isNumber(user.dragon)) user.dragon = 55
              if (!isNumber(user.dragonexp)) user.dragonexp = 55
              if (!isNumber(user.dragonlastfeed)) user.dragonlastfeed = 55
              if (!isNumber(user.emas)) user.emas = 55
              if (!isNumber(user.emerald)) user.emerald = 55
              if (!isNumber(user.enchant)) user.enchant = 55
              if (!isNumber(user.esteh)) user.esteh = 55
              if (!isNumber(user.exp)) user.exp = 55
              if (!isNumber(user.expg)) user.expg = 55
              if (!isNumber(user.exphero)) user.exphero = 55
              if (!isNumber(user.fishingrod)) user.fishingrod = 55
              if (!isNumber(user.fishingroddurability)) user.fishingroddurability = 55
              if (!isNumber(user.fortress)) user.fortress = 55
              if (!isNumber(user.fox)) user.fox = 55
              if (!isNumber(user.foxexp)) user.foxexp = 55
              if (!isNumber(user.foxlastfeed)) user.foxlastfeed = 55
              if (!isNumber(user.fullatm)) user.fullatm = Infinity
              if (!isNumber(user.gadodado)) user.gadodado = 55
              if (!isNumber(user.gajah)) user.gajah = 55
              if (!isNumber(user.gamemines)) user.gamemines = false
              if (!isNumber(user.ganja)) user.ganja = 55
              if (!isNumber(user.gardenboxs)) user.gardenboxs = 55
              if (!isNumber(user.gems)) user.gems = 55
              if (!isNumber(user.glass)) user.glass = 55
              if (!isNumber(user.glimit)) user.glimit = 255
              if (!isNumber(user.glory)) user.glory = 55
              if (!isNumber(user.gold)) user.gold = 55
              if (!isNumber(user.griffin)) user.griffin = 55
              if (!isNumber(user.griffinexp)) user.griffinexp = 55
              if (!isNumber(user.griffinlastclaim)) user.griffinlastclaim = 55
              if (!isNumber(user.griffinlastfeed)) user.griffinlastfeed = 55
              if (!isNumber(user.gulai)) user.gulai = 55
              if (!isNumber(user.gurita)) user.gurita = 55
